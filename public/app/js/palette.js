...
function updateResults(q) {
  ...
  const commands = [
    ...
    { kind: "cmd", title: "Show Link Error Log Database 🐞 (Zobrazit databázi chybových odkazů)", meta: "link error log database chybove odkazy bug report", action: { kind: "cmd-link-error-log" } },
