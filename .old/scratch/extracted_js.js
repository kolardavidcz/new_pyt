        ...
        },
        {
            ...
            lectures: [
                ...
                },
                {
                    ...
                    compare: "Moderní Python f-stringy 'f\"{x}\"' jsou elegantnější a bezpečnější náhrada za printf() z C++ nebo String.format() z Javy."
                }
            ],
            exercises: [
                {
        ...
        },
        {
            ...
            lectures: [
                ...
                },
                {
                    ...
                    compare: "Nahrazuje staré Céčkovské funkce z modulu os.path. Používá přetížený operátor '/' pro spojování cest: 'cesta / \"soubor.txt\"'."
                },
                {
