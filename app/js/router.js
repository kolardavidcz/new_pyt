...
import {
  ...
  showSearchResults, showProgress, showChecklist,
} from "./content.js";
...
function targetToRoute(target) {
  ...
  if (kind === "checklist") return { kind: "checklist" };
  return { kind: "home" };
}
...
function routeToHash(route) {
  ...
  if (route.kind === "checklist") return "#/checklist";
  return "#/";
}
...
function parseHash(hash) {
  ...
  if (a === "checklist") return { kind: "checklist" };
  return { kind: "home" };
}
...
function tabToTarget(tab) {
  ...
  if (tab.kind === "checklist") return { kind: "checklist" };
  return { kind: "home" };
}
...
export function renderBreadcrumb(tab) {
  ...
  } else if (tab.kind === "checklist") {
    parts.push(sep());
    parts.push(crumbCurrent("Studijní plán"));
  }
